...
import { CreateAcademicYearDto, CreateTermDto, CreateDepartmentDto, CreateSubjectDto, CreateClassSectionDto, UpdateClassSectionDto, AssignTeacherDto, AssignClassTeacherDto } from './dto/academic-architect.dto';
export declare class AcademicArchitectController {
    ...
    getAllClasses(track?: string): Promise<({
        _count: {
            students: number;
        };
        classTeacher: {
    ...
    updateClass(id: string, dto: UpdateClassSectionDto): Promise<{
        level: import(".prisma/client").$Enums.ClassLevel;
        name: string;
        id: string;
        capacity: number;
    ...
    getAssignmentsByClass(classId: string, track?: string): Promise<({
        subject: {
            department: {
                name: string;
                id: string;
